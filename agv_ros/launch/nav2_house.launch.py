...
def generate_launch_description():
    ...
    # [QUAN TRỌNG] ĐƯỜNG DẪN THẾ GIỚI MỚI (BẢN ĐỒ 2)
    # Thay 'ten_file_world_ngoi_nha.world' bằng tên file world chính xác của bạn
    default_world = os.path.join(pkg_share, 'worlds', 'house_scan.world')
    ...
    set_gazebo_model_path = SetEnvironmentVariable(
        ...
        value=[os.path.dirname(pkg_share), os.pathsep, EnvironmentVariable('GAZEBO_MODEL_PATH', default_value='')]
    )
    ...
    # Khởi chạy Gazebo với thế giới Ngôi nhà
    ...
    # Khai báo ĐỦ 3 đường dẫn cốt lõi
    ...
    # [QUAN TRỌNG] ĐƯỜNG DẪN BẢN ĐỒ MỚI 
    map_path = '/home/duong2005/ros2_ws/map2_3.yaml' 
